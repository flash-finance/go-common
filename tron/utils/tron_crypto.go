...
//  根据 hex encoding private key 生成 hex encoding public key
//	in: hex encoding private key
...
//  根据 hex encoding public key生成 hex encoding address
...
//  根据私钥对交易进行签名，签名不回填transaction对象
//	transaction: 交易
