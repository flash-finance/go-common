...
//  build transaction with giving contract type and contract pb object
...
//  get first contract from transaction
...
//  extract contract object from transaction
...
//  gen refBlockBytes and refBlockHash by giving block, the return values are used in transaction
